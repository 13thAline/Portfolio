  ...
  return (
    <section id="fs-projects" className="relative bg-fs-light py-32 px-8 lg:px-16 overflow-hidden border-t border-black/5">
      ...
      <div className="relative z-10 flex flex-col items-end">
        {/* Asymmetrical Right-focused Header */}
        <div
          ref={headerRef}
          className="opacity-0 [&.revealed]:opacity-100 transition-opacity duration-700 max-w-2xl text-right mb-16"
        >
          <SectionHeader
            title="Selected Work"
            subtitle="Projects"
        ...
        {/* Project Stack - Strictly right aligned */}
        <div className="flex flex-col gap-12 w-full max-w-4xl ml-auto mr-0 pr-0 lg:pr-8">
